...
public://public member functions
    ...
    int j_detail() // function declaration and definition for domestic journey
    {
        ...
        cin >> doj;
        cout << "\1.Amritsar(1) \t\2.Bhatinda(2) \t\3.Chandigarh(3) \t\4.Daman(4)" << endl << endl;
        ...
        if((src==1 && dest==2) || (src==2 && dest==1))//condition
        {
            ...
            cout << "\2.Go air(2)\t14:00\t\t17:05\t\tRs.5500\t\tRefundable\n";
            cout << "\3.Indigo(3)\t19:00\t\t22:05\t\tRs.6000\t\tRefundable\n";
        }
        ...
        else if((src==1 && dest==4) || (src==4 && dest==1))//condition
        {
            ...
            cout << "\2.Go air(2)\t14:00\t\t17:05\t\tRs.4250\t\tRefundable\n";
            cout << "\3.Indigo(3)\t19:00\t\t22:05\t\tRs.6100\t\tRefundable\n";
        }
        ...
        else if((src==2 && dest==3) || (src==3 && dest==2))//condition
        {
            ...
            cout << "\2.Go air(2)\t14:00\t\t17:05\t\tRs.2500\t\tRefundable\n";
            cout << "\3.Indigo(3)\t19:00\t\t22:05\t\tRs.2890\t\tRefundable\n";
        }
        ...
        else if((src==2 && dest==4) || (src==4 && dest==2))//condition
        {
            ...
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Air India(1)\t08:00\t\t11:05\t\tRs.5000\t\tRefundable\n";
            cout << "\2.Go air(2)\t14:00\t\t17:05\t\tRs.4500\t\tRefundable\n";
            cout << "\3.Indigo(3)\t19:00\t\t22:05\t\tRs.6000\t\tRefundable\n";
        }
        else if((src==3 && dest==4) || (src==4 && dest==3))//condition
         {
            ...
            cout << "\2.Go air(2)\t14:00\t\t17:05\t\tRs.5508\t\tRefundable\n";
            cout << "\3.Indigo(3)\t19:00\t\t22:05\t\tRs.6050\t\tRefundable\n";
        }
...
public://public member functions
    ...
    int j_detaili()// function declaration and definition for journey details
    {
        ...
        {
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Go air(1)\t10:00\t\t14:05\t\tRs.25000\tRefundable\n";
            cout << "\2.Go air(2)\t14:00\t\t18:05\t\tRs.21500\tRefundable\n";
        ...
        {
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Go air(1)\t10:00\t\t14:05\t\tRs.25500\tRefundable\n";
            cout << "\2.Go air(2)\t14:00\t\t18:05\t\tRs.21300\tRefundable\n";
        ...
        {
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Go air(1)\t10:00\t\t14:05\t\tRs.52500\tRefundable\n";
            cout << "\2.Go air(2)\t14:00\t\t18:05\t\tRs.59420\tRefundable\n";
        ...
        {
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Go air(1)\t10:00\t\t14:05\t\tRs.17800\tRefundable\n";
            cout << "\2.Go air(2)\t14:00\t\t18:05\t\tRs.14900\tRefundable\n";
        ...
        {
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Go air(1)\t10:00\t\t14:05\t\tRs.32000\tRefundable\n";
            cout << "\2.Go air(2)\t14:00\t\t18:05\t\tRs.38500\tRefundable\n";
            cout << "\3.Emirates(3)\t18:00\t\t22:05\t\tRs41259\tRefundable\n";        }

        else if(srci==2 && desti==5 || (srci==5 && desti==2))//condition
        {
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Go air(1)\t10:00\t\t14:05\t\tRs.82500\tRefundable\n";
            cout << "\2.Go air(2)\t14:00\t\t18:05\t\tRs.87550\tRefundable\n";
    ...
    int select_flighti()//function declaration and definition for selecting flight
    {
        ...
        case 1://condition
            cout << "\nFlight selected:" <<endl;
            cout << "Go air" << endl;
            strcpy(f_i,"Go air");//copy to string
